...
#define NRO_FRAMES_ESPERANDO_ATAQUE 3
#define NRO_FRAMES_DISPARO 7
#define NRO_FRAMES_AGACHAMIENTO_NORMAL 3
#define NRO_FRAMES_AGACHAMIENTO_CON_PISTOLA (NRO_FRAMES_AGACHAMIENTO_NORMAL)
#define NRO_FRAMES_AGACHAMIENTO (NRO_FRAMES_AGACHAMIENTO_NORMAL + NRO_FRAMES_AGACHAMIENTO_CON_PISTOLA)
#define NRO_FRAMES_WOOFSON (NRO_FRAMES_MOVIMIENTO + NRO_FRAMES_PELEA + NRO_FRAMES_ESPERANDO_ATAQUE + NRO_FRAMES_DISPARO + NRO_FRAMES_AGACHAMIENTO)
